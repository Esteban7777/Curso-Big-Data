...
robos <- read.csv('robos.csv')
train <- cbind.data.frame(train,robos)
```
...
Para conocer mejor el contexto en el que se ubica la vivienda, se crea la variable estrato a partir de la información del DANE. (William debe ampliar la explicación sobre la creación de esta variable).
